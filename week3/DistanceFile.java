 ...
 * 4.3 Distance File
 * 
 * Modify the program you wrote for Programming Challenge 2 (Distance Traveled)
 * so it writes the report to a file instead of the screen. Open the file in
 * Notepad or another text editor to confirm the output. The distance a vehicle
 * travels can be calculated as follows: D i s t a n c e = S p e e d * T i m e
 ...
 * similar to the one that follows: Hour Distance Traveled 1 40 2 80 3 120 Input
 * Validation: Do not accept a negative number for speed and do not accept any
...
public class DistanceFile
{
	...
	/**
	 * Main method gets input, validates it and appends results of calculation to a
	 * file
	 * 
	 * @param args ignored
	 */
