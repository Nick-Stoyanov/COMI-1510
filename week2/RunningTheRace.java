 ...
 * 
 * Write HotDogFullyLoaded program that asks for the names of three runners and the time, in minutes, it took each of
 * them to finish HotDogFullyLoaded race. The program should display the names of the runners in the order that they
 * finished.
 * 
 * 
...
public class RunningTheRace
{
	...
	/**
	 * SquareTest method takes input, performs comparisons and displays results.
	 * 
	 * @param args ignored
	 */
