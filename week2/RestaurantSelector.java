/**
 * Program to help user select a restaurant based on diatery restrictions
 */
package chapter3;
 ...
 * follows: Joe’s Gourmet Burgers – Vegetarian: No, Vegan: No, Gluten-Free: No Main Street Pizza Company – Vegetarian:
 * Yes, Vegan: No, Gluten-Free: Yes Corner Café – Vegetarian: Yes, Vegan: Yes, Gluten-Free: Yes Mama’s Fine Italian –
 * Vegetarian: Yes, Vegan: No, Gluten-Free: No The Chef’s Kitchen – Vegetarian: Yes, Vegan: Yes, Gluten-Free: Yes Write
 * a program that asks whether any members of your party are vegetarian, vegan, or gluten-free, and then displays only
 * the restaurants that you may take the group to. Here is an example of the program’s output: Is anyone in your party a
 * vegetarian? yes [Enter] Is anyone in your party a vegan? no [Enter] Is anyone in your party gluten-free? yes [Enter]
 * Here are your restaurant choices: Main Street Pizza Company Corner Cafe The Chef's Kitchen Here is another example of
 * the program’s output: Is anyone in your party a vegetarian? yes [Enter] Is anyone in your party a vegan? yes [Enter]
 * Is anyone in your party gluten-free? yes [Enter] Here are your restaurant choices: Corner Cafe The Chef's Kitchen
 * 
 * 
 * 
...
public class RestaurantSelector
{
    ...
    /**
     * Main method prompts user to enter input then determines and displays results
     * 
     * @param args
     */
