 ...
 * BMI is often used to determine whether a person is overweight or underweight for his or her height. A
 * person’s BMI is calculated with the following formula:( B M I = W e i g h t × 703 / H e i g h t ^ 2 ) where weight is
 * measured in pounds and height is measured in inches. The program should display a message indicating
 * whether the person has optimal weight, is underweight, or is overweight. A sedentary person’s weight is considered
 * optimal if his or her BMI is between 18.5 and 25. If the BMI is less than 18.5, the person is considered underweight.
