 ...
 * 3.7 Sorted Names
 * 
 * Write a program that asks the user to enter three names, and then displays the names sorted in ascending order. For
 * example, if the user entered “Charlie”, “Leslie”, and “Andy”, the program would display: Andy, Charlie, Leslie
 * 
...
{
    /**
     *  Main methon takes three inputs then compares them and displays in alphabetical order
     * @args ignored
     */
