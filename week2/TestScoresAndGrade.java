/**
 * Program to take three inputs for test scores, calculate their average and assign a grade
 */
 ...
 * 
 * Write a program that has variables to hold three test scores. The program should ask the user to enter three test
 * scores and then assign the values entered to the variables. The program should display the average of the test scores
 * and the letter grade that is assigned for the test score average. Use the grading scheme in the following table:
...
public class TestScoresAndGrade
{
	...
	// Display results
	JOptionPane.showMessageDialog(null, String.format("Your average score is: %.1f", averageScore) + '\n' +
					"Your grade is: " + grade);
