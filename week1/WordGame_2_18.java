...
/**
 * This program asks user for name, age, city name, college name, profession, type of animal and a pet's name to tell a
 * story.
 * 
...
public class WordGame_2_18
{
	...
	JOptionPane.showMessageDialog(null, "There once was a person named " + name + " who lived in " + cityName + ". "
		...
		+ typeOfAnimal + " named " + petName + ". " + "They both lived happily ever after!");
    } // End main
} // End class\
